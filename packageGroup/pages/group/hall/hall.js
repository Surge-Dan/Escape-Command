...
Page({
  ...
  onTaskTap(e) {
    ...
    if (!taskId) return
    wx.navigateTo({
      url: '/packageGroup/pages/group/hall/detail/detail?taskId=' + taskId
    })
  },
  ...
  onCreateTap() {
    wx.navigateTo({
      url: '/packageGroup/pages/group/hall/create-task/create-task'
    })
  },
  ...
  onMatchGoTap() {
    ...
    if (r.roomId) {
      wx.navigateTo({
        url: '/packageGroup/pages/group/room/room?roomId=' + r.roomId + '&taskId=' + r.taskId
      })
    } else {
      wx.navigateTo({
        url: '/packageGroup/pages/group/hall/detail/detail?taskId=' + r.taskId
      })
    }
  }
})
