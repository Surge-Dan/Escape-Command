...
const CATEGORIES = [
  ...
  },
  {
    ...
    accentColor: '#D98A5C',
    items: [
      { label: '我的收藏', path: '/packageBiz/pages/collection/collection', icon: '/assets/icons/bookmark-brand.svg' },
      { label: '分类', path: '/packageBiz/pages/collection-category/collection-category', icon: '/assets/icons/layers.svg' },
      { label: '主题', path: '/packageBiz/pages/theme-market/theme-market', icon: '/assets/icons/sparkles.svg' },
      { label: '导出', path: '/packageBiz/pages/data-export/data-export', icon: '/assets/icons/share-2.svg' }
    ]
  },
  {
    id: 'growth',
    ...
    accentColor: '#C9B037',
    items: [
      { label: '每日挑战', path: '/packageBiz/pages/daily-challenge/daily-challenge', icon: '/assets/icons/zap-coral.svg' },
      { label: '成就墙', path: '/packageBiz/pages/achievements/achievements', icon: '/assets/icons/award-lemon.svg' },
      { label: '徽章', path: '/packageBiz/pages/badges/badges', icon: '/assets/icons/award-brand-strong.svg' },
      { label: '统计', path: '/packageBiz/pages/stats/stats', icon: '/assets/icons/target.svg' }
    ]
  },
  {
    id: 'settings',
    ...
    accentColor: '#6B7280',
    items: [
      { label: '资料', path: '/packageBiz/pages/profile-edit/profile-edit', icon: '/assets/icons/user-brand.svg' },
      { label: '破圈画像', path: '/packageBreakthrough/pages/breakthrough-profile/breakthrough-profile', icon: '/assets/icons/zap-coral.svg' },
      { label: '设置', path: '/packageBiz/pages/settings/settings', icon: '/assets/icons/settings-brand.svg' },
      { label: '帮助', path: '/packageBiz/pages/help/help', icon: '/assets/icons/compass.svg' },
      { label: '关于', path: '/packageBiz/pages/about/about', icon: '/assets/icons/compass-ink-faint.svg' }
    ]
  }
]
