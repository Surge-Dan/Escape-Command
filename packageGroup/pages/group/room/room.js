...
Page({
  ...
  onShareAppMessage() {
    ...
    return {
      ...
      path: `/packageGroup/pages/group/room/room?roomId=${roomId}&from=share`,
      imageUrl: '/packageBt/images/coffee-shop.webp'
    }
  },
  ...
  onStartEscape() {
    ...
    wx.redirectTo({
      url: '/packageGroup/pages/group/escape-record/escape-record?roomId=' + this.data.roomId
    })
  },
